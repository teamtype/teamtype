...
pub fn set_mode(path: PathBuf, mode: u32) -> Result<()> {
    #[cfg(unix)]
    {
...
pub fn check_mode(path: &Path, allowed_permissions: u32) -> Result<()> {
    #[cfg(unix)]
    {
...
pub fn create_with_mode(file: PathBuf, mode: u32) -> Result<File> {
    #[cfg(unix)]
    {
        Ok(OpenOptions::new()
            .create_new(true)
