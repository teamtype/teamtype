...
This release adds a couple of features and fixes some bugs.

Special thanks to @caleb for putting in a lot of work behind the scenes to clean up various aspects of our code base.
...
## When Neovim plugin loses connection to daemon, make buffer read-only
